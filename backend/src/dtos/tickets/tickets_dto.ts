...
export const CreateTicketSchema = z.object({
    ...
    department_id: z.coerce.number().min(1, "Departemen tidak boleh kosong"),
    member_id: z.coerce.number().min(1, "Pengguna tidak boleh kosong"),
    ...
    modul: z.string().min(1, "Modul tidak boleh kosong.").optional(),
...
export const UpdateTicketSchema = z.object({
    ...
    department_id: z.coerce.number().min(1, "Departemen tidak boleh kosong").optional(),
    member_id: z.coerce.number().min(1, "Pengguna tidak boleh kosong").optional(),
    ticket_no: z.string().min(1, "No tiket tidak boleh kosong.").optional(),

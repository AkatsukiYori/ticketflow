...
const Controller = __importStar(require("../domain/fileUploader/controller"));
const routerFileUpload = (0, express_1.Router)();
const upload = (0, uploads_1.createUploader)();
...
exports.default = routerFileUpload;

...
const Middleware = __importStar(require("../middleware/documentationMiddleware"));
const Controller = __importStar(require("../domain/documentation/controller"));
const routerDocumentation = (0, express_1.Router)();
...
exports.default = routerDocumentation;

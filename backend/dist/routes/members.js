...
const Controller = __importStar(require("../domain/members/controller"));
const Middleware = __importStar(require("../middleware/membersMiddleware"));
const routerMembers = (0, express_1.Router)();
